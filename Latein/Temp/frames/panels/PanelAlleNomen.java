...
import latein.Main;
import übersetzung.ZusammenfassungNomen;
import übersetzung.zusammenfassung;

public class PanelAlleNomen extends JPanel {
	JLabel lb1_vocs;
	public static JScrollPane sp1_anzeige;
	CommonButton b1_go;
	
	public PanelAlleNomen(JPanel p) {
		setLayout(null);
		
		lb1_vocs = new JLabel(ZusammenfassungNomen.returnAlleNomen(), JLabel.CENTER);
