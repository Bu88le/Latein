...
public class PanelÜbersetzungNomen extends JPanel{
	CommonButton b1_go;
	JLabel lb1_translation, lb2_fehler;
	public static JScrollPane sp1;
	
	
	public PanelÜbersetzungNomen() {
		setCursor(new Cursor(Cursor.DEFAULT_CURSOR));
	 	setLayout(null);
		
		
		lb1_translation = new JLabel(ÜbergabeNomen.returngv());
		...
		lb2_fehler.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Main.mf.panelÜbersetzungsFehler(2);					
			}
