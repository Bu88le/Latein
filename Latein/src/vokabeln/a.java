...
public class a {
	...
	final static public String[] verbena = {"labor", "pecc", "am", "laud", "abalien", "abdic", "abequit", "aberr", "abiudic","abiur", "ableg", "abloc", "abneg", "abnoct", "abnut", "abomin", "abrog", "abst", "abund", "accel", "acclam", "acclar", "acclin", "accommod", "accub", "accumul", "accur", "accus", "accusit", "acerb", "acerv", "adaequ", "adagger", "adallig", "adam", "adambul", "adapt", "adaqu", "adhort", "adinspect", "adiudic", "adiur", "adiut", "adiuv", "admatur", "admigr", "adminicul", "administr", "admurmur", "admutil", "adnat", "adopt"};
