...
public class frameimperfekt {
	...
	static class AListener implements ActionListener{
		public void actionPerformed(ActionEvent ae) {
			if (ae.getSource() == frameimperfekt.button1) {
			...
			}else if (ae.getSource() == frameimperfekt.button5) {
				...
				framemain.framem();
			}else if (ae.getSource() == frameimperfekt.button6) {
				button1.setVisible(false);
				button2.setVisible(false);
				button3.setVisible(false);
				button4.setVisible(false);
				...
				frame.auswahl();
			}else if(ae.getSource() == frameimperfekt.button7) {
				System.exit(0);
			}
		}
	}
