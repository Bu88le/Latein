...
public class Formauswahl {
	...
	public Formauswahl(String s) {
		 ...
		 * erhält einen String s = gesuchtevokabel.
	...
	void passivgrob() {
		...
		/**Die erste if-Schleife prüft, ob die Vokabel Perfekt && Passiv ist
		 * Dies ist an Hand des zweiten Teils des Ausdrucks möglich.
		...
		if (gesuchtevokabel.contains(" ")) {
			...
			if (gesuchtevokabel.endsWith("sum") || gesuchtevokabel.endsWith("es") ||
				...
				/**Diese else-if-Schleife prüft, ob die 
				 ...
				 * == true zurückliefert, dann passivfein()
				 */
			}else {
	...
	void passivfein() {
		...
		/** Die If-Schleife prüft auf Passiv-Endungen*/
		...
		if (gesuchtevokabel.endsWith("or") || gesuchtevokabel.endsWith("ris") || gesuchtevokabel.endsWith("tur") ||
			...
			//-----------------------------------------------------------------------------------
				...
				//-------------------------------------------------------------
					...
					/** Die if-schleife prüft auf Passiv-Endungen und Konjunktiv */
					...
					if(gesuchtevokabel.endsWith("rer") || gesuchtevokabel.endsWith("reris") ||
						...
						/**if schleife die prüft, ob die Vokabel zu
						 * konsonantischen oder i-Erweiterung gehört
						 */
				...
				//------------------------------------------------------------
					...
					/** Else-if Schleife prüft auf Passiv-Ednung && Imperfekt && Indikativ */
			...
			/** Else-If Schleife prüft auf Passiv && Futur I && A-/E-Konjugation */
			...
			/** Prüfe auf Futur I && PAssiv && Indikativ */
				 ...
				 * dann überprüfen, ob Vokabel I-Konjugation || kons-/gemisch. kons Konjugation ist
	...
	void aktiv() {	
		...
		/**Folgende If-Schleife prüft ob die Vokabel Aktiv && Plusquamperfekt ist. */
		...
		/** Folgende Else-if-Schleife prüft, ob die Vokabel Aktiv && Konjunktiv && Plusquamperfekt ist */
		...
		// ---------------------------------------------------
			...
			// ------------------------------------------------------
				...
				/** Folgende If-Schleife prüft, ob die Vokabel zu A-Konjugation gehört */
				...
				/** Folgende Else-If-Schleife prüft, ob die Vokabel zur E-Konjugation gehört */
				...
				/** Folgende Else-If-Schleife prüft, ob die Vokabel zur I-Konjugation gehört */
			...
			/** Folgende Else-IF-Schleife prüft, ob die Vokabel Aktiv && Indikativ && Perfekt ist */
				 ...
				 */
					...
					/** Folgende If-Schleife prüft, ob die Vokabel zur A-Konjugation gehört */
					...
					/** Folgende Else-If-Schleife prüft, ob die Vokabel zu E-Konjugation gehört */
					...
					/** Folgende Else-If-Schleife prüft, ob die Vokabel zur I-Konjagtion gehört */
