...
public class PanelPlusquamperfekt extends CommonPanel {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2891972989215156641L;
	...
	public PanelPlusquamperfekt(JPanel caller) {
		super(caller);
		initGUI();
	}
	...
	private void initGUI() {
		...
		b1_AktivIndikativ.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (Auswahl.aKon) {
					umschreibenAufString(AKonjugation.returnPlusquamperfektAktivIndikativ());
				}
		...
		b3_PassivIndikativ.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (Auswahl.aKon) {
					umschreibenAufString(AKonjugation.returnPlusquamperfektPassivIndikativ());
				}
		...
		b2_AktivKonjunktiv.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				if (Auswahl.aKon) {
					umschreibenAufString(AKonjugation.returnPlusquamperfektAktivKonjunktiv());
				}
		...
		b4_PassivKonjunktiv.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (Auswahl.aKon) {
					umschreibenAufString(AKonjugation.returnPlusquamperfektPassivKonjunktiv());
				}
