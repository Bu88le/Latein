...
public class PanelImperfekt extends CommonPanel {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1685211483573913095L;
	...
	public PanelImperfekt(JPanel caller) {
		super(caller);
		initGUI();
	}
	...
	private void initGUI() {
		...
		b1_AktivIndikativ.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (Auswahl.aKon) {
					umschreibenAufString(AKonjugation.returnImperfektAktivIndikativ());
				}
		...
		b3_PassivIndikativ.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (Auswahl.aKon) {
					umschreibenAufString(AKonjugation.returnImperfektPassivIndikativ());
				}
		...
		b2_AktivKonjunktiv.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				if (Auswahl.aKon) {
					umschreibenAufString(AKonjugation.returnImperfektAktvKonjunktiv());
				}
		...
		b4_PassivKonjunktiv.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (Auswahl.aKon) {
					umschreibenAufString(AKonjugation.returnImperfektPassivKonjunktiv());
				}
