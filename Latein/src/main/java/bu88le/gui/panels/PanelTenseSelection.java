...
public class PanelTenseSelection extends CommonPanel {
	...
	JButton						b1_praesens, b2_imperfekt, b3_futurI, b4_perfekt, b5_plusquamperfekt, b6_futurII;
	...
	private void initGUI() {
		...
		b1_praesens = new JButton("Pr�sens");
		b1_praesens.setBackground(Color.BLACK);
		b1_praesens.setForeground(Color.WHITE);
		b1_praesens.setCursor(new Cursor(Cursor.HAND_CURSOR));
		b1_praesens.setPreferredSize(new Dimension(250, 30));
		b1_praesens.addActionListener(e -> {
			threadTesting();
			MainFrame.panelPraesens();
		});
		c.fill = GridBagConstraints.VERTICAL;
		c.gridx = 0;
		c.gridy = 0;
		c.insets = new Insets(0, 0, 5, 0);
		panelCenter.add(b1_praesens, c);
		...
		b2_imperfekt.addActionListener(e -> {
			threadTesting();
		...
		b4_perfekt.addActionListener(e -> {
			threadTesting();
		...
		b5_plusquamperfekt.addActionListener(e -> {
			threadTesting();
		...
		b6_futurII.addActionListener(e -> {
			threadTesting();
