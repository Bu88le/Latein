...
public class PanelFuturI extends CommonPanel {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1245397286882969380L;
	...
	public PanelFuturI(JPanel caller) {
		super(caller);
		initGUI();
	}
	...
	private void initGUI() {
		...
		b1_AktivIndikativ.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (Auswahl.aKon) {
					umschreibenAufString(AKonjugation.returnFuturIAktivIndikativ());
				}
		...
		b3_PassivIndikativ.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (Auswahl.aKon) {
					umschreibenAufString(AKonjugation.returnFuturIPassivIndikativ());
				}
